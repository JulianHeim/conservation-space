 ...
 */
public class BAMActivityCriteria {
	 ...
	 */
	public BAMActivityCriteria setDateRange(DateRange dateRange) {
	 ...
	 * @return the current criteria
	 */
	public BAMActivityCriteria setIds(List<String> ids) {
		this.ids = ids;
		return this;
	}
	 ...
	 * @return the current criteria
	 */
	public BAMActivityCriteria addId(String id) {
		if (ids == null) {
	 ...
	 * @return the current criteria
	 */
	public BAMActivityCriteria setIncludedUsername(String username) {
	 ...
	 * @return the current criteria
	 */
	public BAMActivityCriteria setExcludedUsername(String username) {
	 ...
	 * @return the current criteria
	 */
	public BAMActivityCriteria setCriteriaType(CriteriaType criteriaType) {
