...
public class ProjectServiceImpl implements ProjectService {
	...
	public ProjectInstance save(ProjectInstance instance, Operation operation) {
		return saveInstance(instance, operation,
				instance.getDmsId() == null ? new BeforeProjectPersistEvent(instance) : null);
	}
	...
	private void cancelInternal(ProjectInstance instance, Operation operation, boolean permanent) {
		...
		context.put(
				LinkReferencesDeletionService.CUSTOM_ERROR,
				"There are problems during deletion of project's ("
		...
		schedulerService.schedule(LinkReferencesDeletionService.BEAN_ID, configuration, context);
	}
