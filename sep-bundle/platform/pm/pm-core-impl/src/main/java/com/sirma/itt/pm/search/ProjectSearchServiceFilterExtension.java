...
public class ProjectSearchServiceFilterExtension implements
		SearchServiceFilterExtension<ProjectInstance> {
	...
	public <S extends SearchArguments<ProjectInstance>> S getFilter(String filterName,
	 ...
	 */
	@Override
	public <S extends SearchArguments<ProjectInstance>> Map<String, S> getFilters(
	...
	public List<String> getFilters(String placeHolder) {
		return Arrays.asList("listAllProjects", "listActiveProjects", "listCompletedProjects",
				"filterAllProjects", "permissionsProject", "visibleProject");
	}
