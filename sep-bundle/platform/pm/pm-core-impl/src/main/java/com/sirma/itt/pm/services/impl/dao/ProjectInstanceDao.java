...
public class ProjectInstanceDao extends
	...
	protected void onInstanceUpdated(ProjectInstance instance) {
		...
		if (properties.get(ProjectProperties.CREATED_BY) == null) {
			setCurrentUserTo(instance, ProjectProperties.CREATED_BY);
		}
		...
		setCurrentUserTo(instance, ProjectProperties.MODIFIED_BY);
		Date date = new Date();
		if (properties.get(ProjectProperties.CREATED_ON) == null) {
			properties.put(ProjectProperties.CREATED_ON, date);
	}
		properties.put(ProjectProperties.MODIFIED_ON, date);
	...
	protected Iterable<InstanceReference> getCurrentChildren(ProjectInstance targetInstance) {
		...
		return new LinkReferenceIterable(links);
	}
