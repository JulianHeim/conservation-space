		...
		_create : function() {
		    ...
		    var widgetDom =
		        '<div class="rm-wrapper"> \
	                ...
	                <div class="rm-footer"> \
                        <input type="button" id="saveButton" value="Save" class="btn btn-primary rm-save-button standard-button" /> \
                        <input type="button" id="cancelButton" value="Cancel" class="btn btn-default rm-cancel-button standard-button" /> \
	                </div> \
		        </div>';
