...
public class ProjectSearchAction extends
	...
	private static final Sorter SORTER_CREATED_ON = new Sorter(
			ProjectProperties.CREATED_ON, Sorter.SORT_DESCENDING);
	...
	public void myProjectsDashletSearchActionObserver(
			@Observes @SelectedDashletToolbarAction(dashlet = MyProjectsPanel.MYPROJECTS_DASHLET, action = PmNavigationConstants.PROJECT_SEARCH) DashletToolbarActionEvent event) {
