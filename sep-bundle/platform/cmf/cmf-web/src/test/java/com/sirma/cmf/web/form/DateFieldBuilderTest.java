...
public class DateFieldBuilderTest extends FormBuilderBaseTest {
	...
	public void updateFieldTest() {
		...
		Assert.assertEquals(styleClass, "nameField cmf-date-field");
		...
		Assert.assertEquals(styleClass, "nameField cmf-datetime-field");
	...
	public void addAfterFieldContentTest() {
		...
		Assert.assertEquals(wrapper.getChildCount(), 3);
