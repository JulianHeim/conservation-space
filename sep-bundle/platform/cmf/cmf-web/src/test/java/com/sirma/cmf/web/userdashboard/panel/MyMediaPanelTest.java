...
public class MyMediaPanelTest extends CMFTest {
	...
	/**
	 * Test method for retrieving media actions based on null-able instance.
	 */
	public void getMediaActionEmptyInstanceTest() {
		Assert.assertEquals(myMediaPanel.getMediaActions(null), new ArrayList<Action>());
	}

	/**
	 * Test method for retrieving null-able media actions.
	 */
	public void getMediaActionsNotSupportedTest() {
		myMediaPanel.setMediaActions(null);
		Assert.assertEquals(myMediaPanel.getMediaActions(documentInstnace), new ArrayList<Action>());
	}

	/**
	 * Test method for retrieving media action based on current document instance.
	 */
	public void getMediaActionForCurrentInstnaceTest() {
		Map<Serializable, List<Action>> actions = new HashMap<Serializable, List<Action>>();
		actions.put(documentInstnace.getId(), new ArrayList<Action>(2));
		myMediaPanel.setMediaActions(actions);
		Assert.assertEquals(myMediaPanel.getMediaActions(documentInstnace),
