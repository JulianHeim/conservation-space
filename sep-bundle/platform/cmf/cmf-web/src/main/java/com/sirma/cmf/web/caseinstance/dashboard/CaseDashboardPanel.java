...
public class CaseDashboardPanel implements CaseDashboard {
	 ...
	 */
	@Extension(target = CaseDashboard.EXTENSION_POINT, enabled = true, order = 40, priority = 1)
	public static class CaseWorkflowsPanel implements PageFragment {

		@Override
		public String getPath() {
			return "/case/dashboard-panel/case-workflows-panel.xhtml";
		}
	}
	 ...
	 */
	@Extension(target = CaseDashboard.EXTENSION_POINT, enabled = true, order = 110, priority = 1)
