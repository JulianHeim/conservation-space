...
public class DocumentMoveAction extends
	...
	public String acceptSelectedTarget() {
		...
		if (action != null) {
			...
			if (ActionTypeConstants.MOVE_OTHER_CASE.equals(actionId)) {
				navigation = moveToOtherCase();
			}
	...
	protected String moveToOtherCase() {
		...
		if (selectedSectionInstance != null) {
			SectionInstance sectionInstance = sectionService.loadByDbId(selectedSectionInstance
					.getId());
