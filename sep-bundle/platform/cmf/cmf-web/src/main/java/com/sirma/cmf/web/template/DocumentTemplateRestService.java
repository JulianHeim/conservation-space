...
public class DocumentTemplateRestService extends EmfRestService {
	...
	public String getTemplateContent(@PathParam("template-id") String templateId) {
		TemplateInstance template = templateService
				.getTemplateWithContent(Long.valueOf(templateId));
		return JsonUtil.transformInstance(template, TemplateProperties.TYPE, TemplateProperties.TITLE,
				TemplateProperties.CONTENT).toString();
	}
