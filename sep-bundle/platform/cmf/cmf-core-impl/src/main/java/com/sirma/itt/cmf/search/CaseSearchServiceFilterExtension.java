...
public class CaseSearchServiceFilterExtension implements SearchServiceFilterExtension<CaseInstance> {
	...
	public <S extends SearchArguments<CaseInstance>> S getFilter(String filterName,
	 ...
	 * @return the s
	 */
	protected <S extends SearchArguments<CaseInstance>> S addContextFilters(S arguments,
	 ...
	 */
	@Override
	public <S extends SearchArguments<CaseInstance>> Map<String, S> getFilters(String placeHolder,
			Context<String, Object> context) {
	...
	public List<String> getFilters(String placeHolder) {
		return new ArrayList<String>(Arrays.asList("listAllCaseInstances",
				"listActiveCaseInstances", "listCaseInstancesFromUser",
				"listLockedDocumentsFromUser", "listEditedDocumentsByUser"));
	}
