...
public class TaskSearchServiceFilterExtension implements
		SearchServiceFilterExtension<AbstractTaskInstance> {
	...
	public <S extends SearchArguments<AbstractTaskInstance>> S getFilter(String filterName,
	 ...
	 */
	@Override
	public <S extends SearchArguments<AbstractTaskInstance>> Map<String, S> getFilters(
			String placeHolder, Context<String, Object> context) {
	...
	public List<String> getFilters(String placeHolder) {
		return Arrays.asList("getOpenTaskFilter", "getHighPriorityTaskFilter",
				"getDueDateTodayTaskFilter", "getOverdueDateTaskFilter", "getPoolableTaskFilter",
				"getBaseTaskFilter", "getAllTasksFilter");
	}
	 ...
	 * @return the s
	 */
	public <S extends SearchArguments<AbstractTaskInstance>> S addContextQuery(S arguments,
	...
	protected Serializable convertToID(List<Resource> authorities) {
		ArrayList<String> authoritiesIds = new ArrayList<String>(authorities.size());
