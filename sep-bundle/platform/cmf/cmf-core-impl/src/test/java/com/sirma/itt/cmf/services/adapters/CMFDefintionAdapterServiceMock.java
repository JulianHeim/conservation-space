...
public class CMFDefintionAdapterServiceMock implements DMSDefintionAdapterService {
	 ...
	 *             the dMS exception
	 */
	protected List<DMSFileDescriptor> searchDefinitionsInDms(String uri, Class<?> definitionClass)
			throws DMSException {
		...
		List<DMSFileDescriptor> defDescriptor = new LinkedList<DMSFileDescriptor>();
