...
public class DocumentRoleEvaluatorTest extends CmfTest {
	...
	/**
	 * Test filter_not signed.
	 */
	@SuppressWarnings("unchecked")
	public void testFilter_notSigned() {
		DocumentRoleEvaluator evaluator = createEvaluator();
	...
	public void testFilter_permissionLocked_locked_notSameUser_adminRole() {
		...
		Mockito.when(
				resourceService.equals(Mockito.any(Resource.class), Mockito.eq("testUserName")))
				.thenReturn(false);
	...
	public void testFilter_permissionLocked_locked_sameUser() {
		...
		Mockito.when(resourceService.equals(Mockito.any(Resource.class), Mockito.eq("emf:user")))
				.thenReturn(true);
	...
	public void testRoleEvaluation_creator() {
		...
		Mockito.when(resourceService.equals(resource, "emf:user")).thenReturn(true);
	...
	public void testRoleEvaluation_notCreator() {
		...
		Mockito.when(resourceService.equals(resource, "emf:admin")).thenReturn(false);
