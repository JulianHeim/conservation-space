...
import com.sirma.itt.cmf.services.impl.RenditionServiceImpl;
...
public class BaseArquillianCITest extends Arquillian {
	...
	protected static TestResouceBuilderWrapper defaultBuilder(TestPackageBuilder builder) {
		return new TestResouceBuilderWrapper(builder.exclude(ModulesInfo.CMF_CORE_IMPL))
				...
				.addClasess(RenditionServiceImpl.class, LinkProviderServiceMock.class,
						GroupServiceImpl.class, PeopleServiceImpl.class,
						GroupServiceImplMock.class, PeopleServiceImplMock.class,
						CommentServiceImplMock.class);
	}
	...
	protected DocumentInstance uploadDocument(SectionInstance parent,
			DMSFileAndPropertiesDescriptor descriptor) {
