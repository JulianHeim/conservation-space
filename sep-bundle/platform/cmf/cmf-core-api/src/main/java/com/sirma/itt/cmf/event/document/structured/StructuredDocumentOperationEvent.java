...
public abstract class StructuredDocumentOperationEvent extends
	...
	private DMSFileDescriptor documentRequest;

	/** The document response. */
	private DMSFileDescriptor documentResponse;
	 ...
	 * @return the document
	 */
	public DMSFileDescriptor getDocumentRequest() {
	 ...
	 *            the document to set
	 */
	public void setDocumentRequest(DMSFileDescriptor document) {
	 ...
	 */
	public DMSFileDescriptor getDocumentResponse() {
	 ...
	 */
	public void setDocumentResponse(DMSFileDescriptor documentResponse) {
