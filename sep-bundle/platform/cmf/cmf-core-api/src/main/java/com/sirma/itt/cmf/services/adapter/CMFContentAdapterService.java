...
public interface CMFContentAdapterService {
	 ...
	 *             the dMS exception
	 */
	DMSFileDescriptor getContentDescriptor(DMSInstance instance) throws DMSException;
	 ...
	 *             the dMS exception
	 */
	DMSFileDescriptor getContentDescriptor(String dmsId) throws DMSException;
	 ...
	 *             the dMS exception
	 */
	DMSFileDescriptor getContentDescriptor(String dmsId, String containerId) throws DMSException;
