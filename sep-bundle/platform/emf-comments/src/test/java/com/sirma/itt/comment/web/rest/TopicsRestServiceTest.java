...
public class TopicsRestServiceTest extends EmfTest {
	...
	public void init() {
		...
		when(resourceService.findResource(anyString())).then(new Answer<Resource>() {
			...
			public Resource answer(InvocationOnMock invocation) throws Throwable {
				...
				user.getUserInfo().put(UserInfo.LAST_NAME, "last name");
				user.getUserInfo().put(UserInfo.FIRST_NAME,
	...
	public void testInvalidFindAll() {
		Response response = service.findAll(null, null, null, null, null, null, null, null, null,
				null, null, null, null, null, null, null, null, null);
		Assert.assertEquals(response.getStatus(), Status.BAD_REQUEST.getStatusCode());
		response = service.findAll(null, "test", null, null, null, null, null, null, null, null,
