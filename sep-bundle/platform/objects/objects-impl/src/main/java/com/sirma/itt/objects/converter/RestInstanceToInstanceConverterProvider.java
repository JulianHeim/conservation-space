...
public class RestInstanceToInstanceConverterProvider extends
	...
	public class RestInstanceToObjectInstanceConverter implements
		...
		public ObjectInstance convert(RestInstance source) {
			...
			Map<String, Serializable> fromRest = propertiesService.convertFromRest(source.getProperties(), definitionModel);
			...
			if (view != null) {
				...
				Map<String, Serializable> viewProperties = propertiesService.convertFromRest(
