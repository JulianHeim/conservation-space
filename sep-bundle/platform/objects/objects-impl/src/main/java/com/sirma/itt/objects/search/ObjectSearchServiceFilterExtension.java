...
public class ObjectSearchServiceFilterExtension implements
		SearchServiceFilterExtension<ObjectInstance> {
	...
	public <S extends SearchArguments<ObjectInstance>> S getFilter(String filterName,
	 ...
	 */
	@Override
	public <S extends SearchArguments<ObjectInstance>> Map<String, S> getFilters(
	...
	public List<String> getFilters(String placeHolder) {
		return Arrays.asList("listAllObjects", "listActiveObjects", "filterAllObjects");
	}
