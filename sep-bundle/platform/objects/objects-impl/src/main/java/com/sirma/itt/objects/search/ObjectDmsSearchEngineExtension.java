...
public class ObjectDmsSearchEngineExtension implements DmsSearchEngineExtension {
	...
	/**
	 * Perform search and maps the {@link DMSFileDescriptor} to specific instances and returns them
	 * as the result.
	 *
	 * @param <E>
	 ...
	 */
	private <E extends DMSFileDescriptor> List<ObjectInstance> performSearch(
