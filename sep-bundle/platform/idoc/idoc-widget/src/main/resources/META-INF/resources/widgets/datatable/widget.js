						...
						if(holder.domainClass == value.domainClass) {
							_.forEach(
									...
									function(property) {
										...
										$scope.updateSelectedProperties(property);
									}
							);
						}
					}
		...
		return {
			...
			link: function(scope, element, attrs) {
				...
				scope.rebuild = function() {
					...
					var searchUrlWithParams = EMF.servicePath;
					...
					if (scope.config.objectSelectionMethod === 'object-search') { 
						...
						searchUrlWithParams += '/object-rest/objectsByIdentity';
						$.ajax({
							type : 'POST',
							url : searchUrlWithParams,
