...
public class WidgetManager {
	...
	private static final String WIDGET_SCRIPT_NAME = "widget.js";

	private static final String COMPONENT_SCRIPT_NAME = "component.js";

	private static final String WIDGET_CSS_NAME = "widget.css";
	...
	/**
	 * Looks for directories with widgets and captures them.
	 * 
	...
	public List<Widget> getWidgets() throws MalformedURLException {
		if (widgets == null) {
			...
			Set<String> resourcePaths = servletContext.getResourcePaths("/widgets/");

			if (resourcePaths != null) {
				for (String path : resourcePaths) {
					if (servletContext.getResource(path + WIDGET_SCRIPT_NAME) != null) {
						Boolean hasStyle = servletContext.getResource(path + WIDGET_CSS_NAME) != null;

						widgets.add(new Widget(path, hasStyle));
					}
				}
			}
		}
