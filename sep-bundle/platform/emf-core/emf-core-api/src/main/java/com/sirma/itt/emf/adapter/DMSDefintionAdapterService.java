...
public interface DMSDefintionAdapterService extends CMFAdapterService {
	 ...
	 */
	List<DMSFileDescriptor> getDefinitions(Class<?> definitionClass) throws DMSException;
	 ...
	 *             on any error
	 */
	String uploadDefinition(Class<?> definitionClass, DMSFileAndPropertiesDescriptor descriptor)
			throws DMSException;
}
