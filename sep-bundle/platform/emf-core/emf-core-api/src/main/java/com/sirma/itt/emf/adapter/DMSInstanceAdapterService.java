...
public interface DMSInstanceAdapterService extends CMFAdapterService {
	 ...
	 *             the dMS exception {@link com.sirma.itt.cmf.beans.LocalFileDescriptor}
	 */
	DMSFileAndPropertiesDescriptor attachDocumentToInstance(DMSInstance documentInstance,
	 ...
	 *             the dMS exception {@link com.sirma.itt.cmf.beans.LocalFileDescriptor}
	 */
	DMSFileAndPropertiesDescriptor attachDocumenToLibrary(DMSInstance documentInstance,
			DMSFileDescriptor descriptor, String customAspect) throws DMSException;
