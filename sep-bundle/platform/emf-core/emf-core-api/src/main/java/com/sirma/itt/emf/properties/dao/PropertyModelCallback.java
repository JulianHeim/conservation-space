...
public interface PropertyModelCallback<E extends PropertyModel> {
	 ...
	 * @return the model
	 */
	Map<PropertyModelKey, PropertyModel> getModel(E model);
	 ...
	 */
	Map<PropertyModelKey, PropertyModel> getModelForLoading(E model);
	 ...
	 *            the properties
	 */
	void updateModel(Map<PropertyModelKey, PropertyModel> target,
