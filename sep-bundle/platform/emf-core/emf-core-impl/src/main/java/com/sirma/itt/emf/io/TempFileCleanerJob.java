...
public class TempFileCleanerJob {
	...
	/** The Constant LOGGER. */
	private static final Logger LOGGER = Logger.getLogger(TempFileCleanerJob.class);
	...
	/**
	 * Gets a list of all files in the {@link TempFileProviderImpl#LONG_LIFE_FILE_DIR temp directory}
