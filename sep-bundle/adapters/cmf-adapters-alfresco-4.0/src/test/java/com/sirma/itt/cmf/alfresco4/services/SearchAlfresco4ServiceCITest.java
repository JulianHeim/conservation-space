...
public class SearchAlfresco4ServiceCITest extends BaseAlfrescoTest {
	...
	/**
	 * Test method for
	 * {@link com.sirma.itt.cmf.alfresco4.services.SearchAlfresco4Service#search(com.sirma.itt.emf.search.SearchArguments, java.lang.Class)}
	 * .
	 */
	@Test
	public void testSearch() throws Exception {

		SearchArguments<DMSFileDescriptor> args = new SearchArguments<DMSFileDescriptor>();
		...
		SearchArguments<DMSFileDescriptor> search = searchAdapter.search(args, CaseInstance.class);
		List<DMSFileDescriptor> result = search.getResult();
	...
	private void checkSorting(List<DMSFileDescriptor> result, Set<String> aspectId, String propId,
		...
		for (DMSFileDescriptor dmsFileDescriptor : result) {
