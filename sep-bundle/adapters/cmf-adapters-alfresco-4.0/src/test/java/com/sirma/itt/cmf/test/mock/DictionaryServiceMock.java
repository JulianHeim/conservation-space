...
public class DictionaryServiceMock implements DictionaryService {
	...
	public DefinitionModel getInstanceDefinition(Instance instance) {
		if (instance instanceof CaseInstance) {
			...
			if (doc.isStandalone()) {
				DocumentDefinitionTemplate createDocumentDefinition = (DocumentDefinitionTemplate) mockupProvider
						.getOrCreateDocumentTemplateDefinition(documentRefId);
				ref = new DocumentDefinitionRefProxy(createDocumentDefinition);
			} else {
				ref = (DocumentDefinitionRef) mockupProvider
	...
	/*
	 * (non-Javadoc)
	 * @see com.sirma.itt.cmf.services.DictionaryService#getProperty(java.lang.Long)
	 */
	/**
	 * {@inheritDoc}
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.sirma.itt.cmf.services.DictionaryService#getDefinitionByValue(java.lang.String,
	...
	/*
	 * (non-Javadoc)
	 * @see com.sirma.itt.cmf.services.DictionaryService#getPrototype(java.lang.String,
	 * java.lang.Long, com.sirma.itt.cmf.beans.PathElement)
	 */
	/**
	 * {@inheritDoc}
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.sirma.itt.cmf.services.DictionaryService#getAllDefinitions(java.lang.Class)
	 */
	/**
	 * {@inheritDoc}
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.sirma.itt.cmf.services.DictionaryService#getDefinitionVersions(java.lang.Class,
	 * java.lang.String)
	 */
	/**
	 * {@inheritDoc}
