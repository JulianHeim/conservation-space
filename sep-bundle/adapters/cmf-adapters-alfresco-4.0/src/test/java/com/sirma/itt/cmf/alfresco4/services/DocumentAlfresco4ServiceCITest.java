...
public class DocumentAlfresco4ServiceCITest extends BaseAlfrescoTest {
	...
	public void uploadContent() {
		try {
			...
			DMSFileAndPropertiesDescriptor uploadContent = documentAdapter.uploadContent(
	...
	public void uploadNewVersion() {
		try {
			...
			DMSFileAndPropertiesDescriptor uploadNewVersion = documentAdapter.uploadNewVersion(
