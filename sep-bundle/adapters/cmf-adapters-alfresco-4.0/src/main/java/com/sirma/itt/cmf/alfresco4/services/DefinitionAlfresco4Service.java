...
public class DefinitionAlfresco4Service implements DMSDefintionAdapterService,
	 ...
	 */
	@Override
	public List<DMSFileDescriptor> getDefinitions(Class<?> definitionClass) throws DMSException {
	 ...
	 *             the dMS exception
	 */
	protected List<DMSFileDescriptor> searchDefinitionsInDms(String uri) throws DMSException {
	 ...
	 *             the dMS exception
	 */
	private String uploadInternal(DMSFileAndPropertiesDescriptor descriptor,
