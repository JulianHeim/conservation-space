 ...
 */
public class AlfrescoRESTClient implements RESTClient, Serializable {
	...
	public InputStream request(HttpMethod method, String uri) throws DMSClientException {
		...
		try {
			...
			throw new DMSClientException(AlfrescoErroreReader.parse(e), 500);
		}
	}
	...
	public HttpMethod rawRequest(HttpMethod method, String uri) throws DMSClientException {
		try {
			...
			throw new DMSClientException(AlfrescoErroreReader.parse(getResponse(method)),
					statusCode);
