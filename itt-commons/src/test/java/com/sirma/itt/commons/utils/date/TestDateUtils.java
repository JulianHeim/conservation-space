/*
 * Created on 23.07.2008 15:47:55
 *
 * Author: Hristo Iliev
 * Company: Sirma-ITT
...
public class TestDateUtils {
    ...
    static {
	changedDates.put(DatePart.MILLISECOND,
		"AD 2001-01-01 00:00:00:001 +0200"); //$NON-NLS-1$
	...
	changedDates.put(DatePart.HOUR_OF_HALF_DAY,
		"AD 2001-01-01 11:00:00:000 +0200"); //$NON-NLS-1$
	changedDates.put(DatePart.HOUR_OF_DAY,
		"AD 2001-01-01 21:00:00:000 +0200"); //$NON-NLS-1$
	changedDates.put(DatePart.DAY_OF_MONTH,
		"AD 2001-01-02 00:00:00:000 +0200"); //$NON-NLS-1$
	changedDates.put(DatePart.DAY_OF_WEEK,
		"AD 2001-01-02 00:00:00:000 +0200"); //$NON-NLS-1$
	changedDates.put(DatePart.DAY_OF_WEEK_IN_MONTH,
		"AD 2001-01-08 00:00:00:000 +0200"); //$NON-NLS-1$
	changedDates.put(DatePart.DAY_OF_YEAR,
		"AD 2001-01-02 00:00:00:000 +0200"); //$NON-NLS-1$
	changedDates.put(DatePart.WEEK_OF_MONTH,
		"AD 2001-01-08 00:00:00:000 +0200"); //$NON-NLS-1$
	changedDates.put(DatePart.WEEK_OF_YEAR,
		"AD 2001-01-08 00:00:00:000 +0200"); //$NON-NLS-1$
    }
	...
	arrayResult.add(new Object[] { DatePart.DAY, staticDate,
		changedDates.get(DatePart.MINUTE) });
	arrayResult.add(new Object[] { DatePart.DAY, staticDate,
		changedDates.get(DatePart.HOUR) });
	arrayResult.add(new Object[] { DatePart.DAY, staticDate,
	...
	arrayResult.add(new Object[] { DatePart.YEAR, staticDate,
		changedDates.get(DatePart.WEEK) });
	arrayResult.add(new Object[] { DatePart.YEAR, staticDate,
		changedDates.get(DatePart.WEEK_OF_MONTH) });
	arrayResult.add(new Object[] { DatePart.YEAR, staticDate,
	...
	arrayResult.add(new Object[] { DatePart.ERA, staticDate,
		changedDates.get(DatePart.DAY_OF_YEAR) });
	arrayResult.add(new Object[] { DatePart.ERA, staticDate,
		changedDates.get(DatePart.MONTH) });
	arrayResult.add(new Object[] { DatePart.ERA, staticDate,
		changedDates.get(DatePart.WEEK) });
	arrayResult.add(new Object[] { DatePart.ERA, staticDate,
		changedDates.get(DatePart.WEEK_OF_MONTH) });
	arrayResult.add(new Object[] { DatePart.ERA, staticDate,
		changedDates.get(DatePart.WEEK_OF_YEAR) });
	arrayResult.add(new Object[] { DatePart.ERA, staticDate,
		changedDates.get(DatePart.YEAR) });
    ...
    public void testIsSame(DatePart part, String date1, String date2)
	    throws ParseException {
	Assert.assertEquals(DateUtils.isSame(part, dateFormat.parse(date1),
		dateFormat.parse(date2)), true);
    }
	...
	arrayResult.add(new Object[] { staticIteratorDate,
		DatePart.MILLISECOND, Integer.valueOf(10), miliseconds });
	...
	arrayResult.add(new Object[] { staticIteratorDate, DatePart.SECOND,
		Integer.valueOf(3), seconds });
	...
	arrayResult.add(new Object[] { staticIteratorDate, DatePart.MINUTE,
		Integer.valueOf(2), minutes });
	...
	arrayResult.add(new Object[] { staticIteratorDate, DatePart.HOUR,
		Integer.valueOf(2), hours });
	...
	arrayResult.add(new Object[] { staticIteratorDate, DatePart.DAY,
		Integer.valueOf(2), days });
	...
	arrayResult.add(new Object[] { staticIteratorDate, DatePart.MONTH,
		Integer.valueOf(3), months });
	...
	arrayResult.add(new Object[] { staticIteratorDate, DatePart.YEAR,
		Integer.valueOf(1), years });
    ...
    public void testIterator(String start, DatePart part, Integer distance,
	    List<String> expected) throws ParseException {
	Iterator<Date> it = DateUtils.iterator(dateFormat.parse(start), part,
		distance.intValue());
	for (String expectedValue : expected) {
	    Assert.assertEquals(DateUtils.isSame(DatePart.MILLISECOND, it
		    .next(), dateFormat.parse(expectedValue)), true);
	}
    }
	...
	arrayResult.add(new Object[] { staticIteratorDate, DatePart.SECOND,
		DatePart.MILLISECOND, Integer.valueOf(100), miliseconds });
	...
	arrayResult.add(new Object[] { staticIteratorDate, DatePart.SECOND,
		DatePart.MILLISECOND, Integer.valueOf(111), miliseconds2 });
	...
	arrayResult.add(new Object[] { staticIteratorDate, DatePart.MINUTE,
		DatePart.SECOND, Integer.valueOf(6), seconds });
	...
	arrayResult.add(new Object[] { staticIteratorDate, DatePart.MINUTE,
		DatePart.SECOND, Integer.valueOf(5), seconds2 });
	...
	arrayResult.add(new Object[] { staticIteratorDate, DatePart.MINUTE,
		DatePart.SECOND, Integer.valueOf(7), seconds3 });
	...
	arrayResult.add(new Object[] { staticIteratorDate,
		DatePart.HOUR_OF_DAY, DatePart.MINUTE, Integer.valueOf(7),
		minutes });
	...
	arrayResult.add(new Object[] { staticIteratorDate,
		DatePart.HOUR_OF_DAY, DatePart.MINUTE, Integer.valueOf(6),
		minutes2 });
	...
	arrayResult.add(new Object[] { staticIteratorDate,
		DatePart.HOUR_OF_DAY, DatePart.MINUTE, Integer.valueOf(5),
		minutes3 });
	...
	arrayResult.add(new Object[] { staticIteratorDate,
		DatePart.DAY_OF_MONTH, DatePart.HOUR_OF_DAY,
		Integer.valueOf(1), hours });
	...
	arrayResult.add(new Object[] { staticIteratorDate,
		DatePart.DAY_OF_WEEK, DatePart.HOUR_OF_DAY, Integer.valueOf(1),
		hours5 });
	...
	arrayResult.add(new Object[] { staticIteratorDate,
		DatePart.DAY_OF_WEEK, DatePart.HOUR_OF_DAY, Integer.valueOf(2),
		hours6 });
	...
	arrayResult.add(new Object[] { staticIteratorDate,
		DatePart.DAY_OF_YEAR, DatePart.HOUR_OF_DAY, Integer.valueOf(1),
		hours9 });
	...
	arrayResult.add(new Object[] { staticIteratorDate,
		DatePart.DAY_OF_YEAR, DatePart.HOUR_OF_DAY, Integer.valueOf(2),
		hours10 });
	...
	arrayResult.add(new Object[] { staticIteratorDate, DatePart.MONTH,
		DatePart.DAY_OF_MONTH, Integer.valueOf(1), days });
	...
	arrayResult.add(new Object[] { staticIteratorDate, DatePart.MONTH,
		DatePart.DAY_OF_MONTH, Integer.valueOf(2), days2 });
	...
	arrayResult.add(new Object[] { staticIteratorDate, DatePart.MONTH,
		DatePart.DAY_OF_MONTH, Integer.valueOf(3), days3 });
	...
	arrayResult.add(new Object[] { staticIteratorDate, DatePart.MONTH,
		DatePart.DAY_OF_MONTH, Integer.valueOf(4), days4 });
	...
	arrayResult.add(new Object[] { staticIteratorDate,
		DatePart.WEEK_OF_MONTH, DatePart.DAY_OF_WEEK,
		Integer.valueOf(1), days5 });
	...
	arrayResult.add(new Object[] {
		"AD 2001-02-01 00:00:00:000 +0200", //$NON-NLS-1$
		DatePart.DAY_OF_WEEK_IN_MONTH, DatePart.DAY_OF_WEEK,
		Integer.valueOf(3), days8 });
	...
	arrayResult.add(new Object[] {
		"AD 2001-01-28 00:00:00:000 +0200", //$NON-NLS-1$
		DatePart.WEEK_OF_YEAR, DatePart.DAY_OF_YEAR,
		Integer.valueOf(3), days9 });
	...
	arrayResult.add(new Object[] { staticIteratorDate, DatePart.YEAR,
		DatePart.MONTH, Integer.valueOf(1), months });
	...
	arrayResult.add(new Object[] { staticIteratorDate, DatePart.YEAR,
		DatePart.MONTH, Integer.valueOf(2), months2 });
	...
	arrayResult.add(new Object[] { staticIteratorDate, DatePart.YEAR,
		DatePart.MONTH, Integer.valueOf(7), months3 });
	...
	arrayResult.add(new Object[] {
		"AD 2000-01-01 00:00:00:000 +0200", //$NON-NLS-1$
		DatePart.YEAR, DatePart.DAY_OF_YEAR, Integer.valueOf(1),
		yearsDays });
    ...
    /**
     * Test
     * {@link DateUtils#rangeIterator(java.util.Calendar, DatePart, DatePart, int)}
     * method.
     * 
     * @param start
    ...
    public void testRangeIterator(String start, DatePart bound, DatePart part,
	    Integer distance, List<String> expected) throws ParseException {
	Iterator<Date> it = DateUtils.rangeIterator(dateFormat.parse(start),
		bound, part, distance.intValue());
	Date next;
	Date expectedDate;
	for (String expectedValue : expected) {
	    next = it.next();
	    expectedDate = dateFormat.parse(expectedValue);
	    Assert.assertEquals(DateUtils.isSame(DatePart.MILLISECOND, next,
		    expectedDate), true);
	}
	if (it.hasNext()) {
	...
	arrayResult.add(new Object[] {
		"AD 2000-01-01 00:00:00:000 +0200", Boolean.TRUE }); //$NON-NLS-1$
	arrayResult.add(new Object[] {
		"AD 2001-01-01 00:00:00:000 +0200", Boolean.FALSE }); //$NON-NLS-1$
	arrayResult.add(new Object[] {
		"AD 2002-01-01 00:00:00:000 +0200", Boolean.FALSE }); //$NON-NLS-1$
	arrayResult.add(new Object[] {
		"AD 2003-01-01 00:00:00:000 +0200", Boolean.FALSE }); //$NON-NLS-1$
	arrayResult.add(new Object[] {
		"AD 2004-01-01 00:00:00:000 +0200", Boolean.TRUE }); //$NON-NLS-1$
	arrayResult.add(new Object[] {
		"AD 2005-01-01 00:00:00:000 +0200", Boolean.FALSE }); //$NON-NLS-1$
	arrayResult.add(new Object[] {
		"AD 2006-01-01 00:00:00:000 +0200", Boolean.FALSE }); //$NON-NLS-1$
	arrayResult.add(new Object[] {
		"AD 2007-01-01 00:00:00:000 +0200", Boolean.FALSE }); //$NON-NLS-1$
	arrayResult.add(new Object[] {
		"AD 2008-01-01 00:00:00:000 +0200", Boolean.TRUE }); //$NON-NLS-1$
	arrayResult.add(new Object[] {
		"AD 2100-01-01 00:00:00:000 +0200", Boolean.FALSE }); //$NON-NLS-1$
	arrayResult.add(new Object[] {
		"AD 0700-02-29 00:00:00:000 +0200", Boolean.TRUE }); //$NON-NLS-1$
	arrayResult.add(new Object[] {
		"AD 1600-02-29 00:00:00:000 +0200", Boolean.TRUE }); //$NON-NLS-1$
	arrayResult.add(new Object[] {
		"AD 1700-02-28 00:00:00:000 +0200", Boolean.FALSE }); //$NON-NLS-1$
	arrayResult.add(new Object[] {
		"AD 1800-02-28 00:00:00:000 +0200", Boolean.FALSE }); //$NON-NLS-1$
	arrayResult.add(new Object[] {
		"BC 0001-01-01 00:00:00:000 +0200", Boolean.TRUE }); //$NON-NLS-1$
	arrayResult.add(new Object[] {
		"BC 0002-01-01 00:00:00:000 +0200", Boolean.FALSE }); //$NON-NLS-1$
	arrayResult.add(new Object[] {
		"BC 0003-01-01 00:00:00:000 +0200", Boolean.FALSE }); //$NON-NLS-1$
	arrayResult.add(new Object[] {
		"BC 0004-01-01 00:00:00:000 +0200", Boolean.FALSE }); //$NON-NLS-1$
	arrayResult.add(new Object[] {
		"BC 0005-01-01 00:00:00:000 +0200", Boolean.TRUE }); //$NON-NLS-1$
	arrayResult.add(new Object[] {
		"BC 16373-02-29 00:00:00:000 +0200", Boolean.TRUE }); //$NON-NLS-1$
	arrayResult.add(new Object[] {
		"BC 17001-02-29 00:00:00:000 +0200", Boolean.TRUE }); //$NON-NLS-1$
    ...
    public void testIsLeapYear(String year, Boolean expected)
	    throws ParseException {
	Date date = dateFormat.parse(year);
	Assert
		.assertEquals(DateUtils.isLeapYear(date), expected
			.booleanValue());
    }
	...
	result
		.add(new Object[] {
			"AD 2008-01-01 00:00:00:000 +0200", parts, new BigInteger("0") }); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    public void testGetDateValue_String_List_BigInteger(String date,
	    List<DatePart> parts, BigInteger expected) throws ParseException {
